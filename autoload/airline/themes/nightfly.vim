...
let s:normal2      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:normal3      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:inactive1    = [s:cadet_blue[0], s:stone_blue[0], s:cadet_blue[1], s:stone_blue[1]]
let s:inactive2    = [s:cadet_blue[0], s:stone_blue[0], s:cadet_blue[1], s:stone_blue[1]]
let s:inactive3    = [s:cadet_blue[0], s:stone_blue[0], s:cadet_blue[1], s:stone_blue[1]]
let s:insert1      = [s:dark_blue[0],  s:emerald[0],    s:dark_blue[1],  s:emerald[1]]
let s:insert2      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:insert3      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:visual1      = [s:dark_blue[0],  s:purple[0],     s:dark_blue[1],  s:purple[1]]
let s:visual2      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:visual3      = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:commandline1 = [s:dark_blue[0],  s:tan[0],        s:dark_blue[1],  s:tan[1]]
let s:commandline2 = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:commandline3 = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:replace1     = [s:dark_blue[0],  s:watermelon[0], s:dark_blue[1],  s:watermelon[1]]
let s:replace2     = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:replace3     = [s:white[0],      s:stone_blue[0], s:white[1],      s:stone_blue[1]]
let s:warning      = [s:tan[0],        s:stone_blue[0], s:tan[1],        s:stone_blue[1]]
let s:error        = [s:watermelon[0], s:stone_blue[0], s:watermelon[1], s:stone_blue[1]]

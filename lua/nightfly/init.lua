...
M.style = function()
  ...
  highlight(0, "Dimmed", { link = "NightflySteelBlue" })
  ...
  -- Completions
  highlight(0, "ComplHint", { link = "Dimmed" })
  ...
  highlight(0, "qfLineNr", { link = "Dimmed" })
  ...
  highlight(0, "@markup.link.gitcommit", { link = "NightflyEmerald" })
  ...
  highlight(0, "@variable.builtin.tmux", { link = "NightflyTurquoise" })
  ...
  if g.nightflyVirtualTextColor then
    ...
    highlight(0, "DiagnosticVirtualTextError", { link = "Dimmed" })
    highlight(0, "DiagnosticVirtualTextWarn", { link = "Dimmed" })
    highlight(0, "DiagnosticVirtualTextInfo", { link = "Dimmed" })
    highlight(0, "DiagnosticVirtualTextHint", { link = "Dimmed" })
    highlight(0, "DiagnosticVirtualTextOk", { link = "Dimmed" })
  end
  ...
  -- Neovim LSP
  highlight(0, "LspCodeLens", { link = "Dimmed" })
  highlight(0, "LspCodeLensSeparator", { link = "Dimmed" })
  ...
  highlight(0, "GitSignsUntracked", { link = "Dimmed" })
  ...
  highlight(0, "DiagnosticSource", { link = "Dimmed" })
  ...
  highlight(0, "MasonMuted", { link = "Dimmed" })
  ...
  highlight(0, "CmpItemMenu", { link = "Dimmed" })
  ...
  highlight(0, "SnacksPickerCol", { link = "Dimmed" })
  ...
  highlight(0, "SnacksPickerTitle", { link = "Dimmed" })
  ...
  highlight(0, "TelescopeResultsSpecialComment", { link = "Dimmed" })
  highlight(0, "TelescopeSelectionCaret", { link = "NightflyWatermelon" })
  highlight(0, "TelescopeTitle", { link = "Dimmed" })
  ...
  highlight(0, "diffChanged", { link = "NightflyMalibu" })

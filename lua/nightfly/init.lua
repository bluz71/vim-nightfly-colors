...
M.style = function()
  ...
  highlight(0, "@markup.emphasis", { fg = orchid, italic = true })
  ...
  highlight(0, "@markup.strike", { strikethrough = true })
  ...
  highlight(0, "@text.diff.add", { link = "@markup.diff.add" })
  highlight(0, "@text.diff.change", { link = "@diff.delta" })
  highlight(0, "@text.diff.delete", { link = "@diff.minus" })
  highlight(0, "@text.diff.delete", { link = "@markup.diff.delete" })
  highlight(0, "@text.emphasis", { link = "@markup.emphasis" })
  ...
  highlight(0, "@text.strike", { link = "@markup.strike" })
  ...
  highlight(0, "@text.title.1.markdown", { link = "@markup.link.1.markdown" })
  highlight(0, "@text.title.1.marker.markdown", { link = "@markup.link.1.marker.markdown" })
  highlight(0, "@text.title.1.vimdoc", { link = "@markup.link.1.vimdoc" })
  highlight(0, "@text.title.2.markdown", { link = "@markup.link.2.markdown" })
  highlight(0, "@text.title.2.marker.markdown", { link = "@markup.link.2.marker.markdown" })
  highlight(0, "@text.title.2.vimdoc", { link = "@markup.link.2.vimdoc" })
  highlight(0, "@text.title.3.markdown", { link = "@markup.link.3.markdown" })
  highlight(0, "@text.title.3.marker.markdown", { link = "@markup.link.3.marker.markdown" })
  highlight(0, "@text.title.4.markdown", { link = "@markup.link.4.markdown" })
  highlight(0, "@text.title.4.marker.markdown", { link = "@markup.link.4.marker.markdown" })
  highlight(0, "@text.title.5.markdown", { link = "@markup.link.5.markdown" })
  highlight(0, "@text.title.5.marker.markdown", { link = "@markup.link.5.marker.markdown" })
  highlight(0, "@text.title.6.markdown", { link = "@markup.link.6.markdown" })
  highlight(0, "@text.title.6.marker.markdown", { link = "@markup.link.6.marker.markdown" })
  highlight(0, "@text.title.help", { link = "@markup.link.help" })
  highlight(0, "@text.title.markdown", { link = "@markup.link.markdown" })

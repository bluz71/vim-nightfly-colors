...
M.core = function()
  ...
  highlight(0, "@class", { link = "NightflyEmerald" })
  highlight(0, "@struct", { link = "NightflyEmerald" })
...
M.plugins = function()
  ...
  -- nvim-navic plugin
  highlight(0, "NavicText", { bg = bg, fg = ash_blue })
  highlight(0, "NavicSeparator", { bg = bg, fg = white })
  highlight(0, "NavicIconsOperator", { bg = bg, fg = watermelon })
  highlight(0, "NavicIconsBoolean", { link = "NavicIconsOperator" })
  highlight(0, "NavicIconsClass", { bg = bg, fg = emerald })
  highlight(0, "NavicIconsConstant", { bg = bg, fg = orange })
  highlight(0, "NavicIconsConstructor", { bg = bg, fg = blue })
  highlight(0, "NavicIconsEnum", { bg = bg, fg = violet })
  highlight(0, "NavicIconsEnumMember", { bg = bg, fg = turquoise })
  highlight(0, "NavicIconsEvent", { link = "NavicIconsConstant" })
  highlight(0, "NavicIconsField", { link = "NavicIconsEnumMember" })
  highlight(0, "NavicIconsFile", { bg = bg, fg = blue })
  ...
  highlight(0, "NavicIconsNull", { bg = bg, fg = green })
  ...
  highlight(0, "NavicIconsString", { bg = bg, fg = tan })

...
M.style = function()
  ...
  highlight(0, "NightflyDiagnosticUndercurlOk", { undercurl = true, sp = emerald })
  ...
  highlight(0, "NightflyDiagnosticUnderlineOk", { underline = true, sp = emerald })
  ...
  highlight(0, "NightflyDiagnosticVirtualTextOk", { bg = dark_blue, fg = emerald })
  ...
  if g.nightflyUndercurls then
    ...
    highlight(0, "DiagnosticUnderlineOk", { link = "NightflyDiagnosticUndercurlOk" })
  else
    ...
    highlight(0, "DiagnosticUnderlineOk", { link = "NightflyDiagnosticUnderlineOk" })
  end
  if g.nightflyVirtualTextColor then
    ...
    highlight(0, "DiagnosticVirtualTextOk", { link = "NightflyDiagnosticVirtualTextOk" })
  else
